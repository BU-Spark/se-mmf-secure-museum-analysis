export const staff_data = [
    {
        ...
        "dataSet": [
          {
            "name" : "All Museums",
             ...
             // "data" : [0.19, 0.19, 0.20, 0.16, 0.14, 0.08]
          },
          // {
            // "name" : "My Museum",
            // "data" : [2.891, 37, 46,  55,  26, 1, 8]
      ...
      },
      {
        ...
        "dataSet": [
          {
            "name" : "All Museums",
            "data" : [5, 234, 845, 491, 157, 113, 62],
            // [0.002,  0.122, 0.443, 0.257, 0.082, 0.059]
          },
          // {
            // "name" : "My Museum",
      ...
      },
      {
        ...
        "dataSet": [
          {
            "name" : "All Museums",
            "data" : [1634, 193, 38,  7, 10,  0, 17,  8],
            //  "data" : [0.856, 0.101, 0.019, 0.003, 0.005, 0 0.008, 0.004]
          },
          // {
            // "name" : "My Museum",
      ...
      },
      {
        ...
        "dataSet": [
          {
            "name" : "All Museums",
            "data" : [794, 454, 637, 281, 508]
            // "data" : [0.416,  0.238, 0.334, 0.147, 0.266]
          },
          // {
            // "name" : "My Museum",
            // "data" : [1,1,66,32,18]
      ...
      },
      {
        ...
        "dataSet": [
          { 
            "name" : "All Museums",
            "data" : [1, 267, 602, 895, 137],
            //  "data" : [0, 0.140, 0.315, 0.469, 0.071]
          },
          // { 
            // "name" : "My Museum",
            // "data" : [1, 12, 13, 14, 57],
      ...
      },
      {
        ...
        "dataSet": [
          {
            "name" : "All Museums",
            "data" : [151, 99, 214, 24, 36, 10, 21, 36, 1397, 44, 119],
            // "data" : [0.079,  0.051, 0.112, 0.012, 0.018, 0.005, 0.011, 0.018, 0.732, 0.023, 0.062],
          },
          // {
            // "name" : "My Museum",
      ...
      },
      {
        ...
        "dataSet": [
          {
            "name" : "All Museums",
            "data" : [151, 24, 151, 214, 36, 10, 1397, 103, 44, 119],
            // "data" : [0.07,  0.01, 0.07, 0.11, 0.01, 0.00, 0.73, 0.05, 0.02, 0.06],
          },
          // {
            // "name" : "My Museum",
      ...
      },
      {
        ...
        "dataSet": [
          {
            "name" : "All Museums",
            "data" : [2, 32, 163, 739, 778, 155, 38],
            // "data" : [0.001,  0.016, 0.085, 0.387, 0.407, 0.081, 0.019]
          },
          // {
            // "name" : "My Museum",
      ...
      },
      {
        ...
        "dataSet": [
          {
            "name" : "All Museums",
            "data" : [155, 960, 691, 101]
            // "data" : [0.081,  0.503, 0.362, 0.052]
          },
          // {
            // "name" : "My Museum",
            // "data" : [1,34,12,7]
      ...
      },
      {
        ...
        "dataSet": [
          {
            "name" : "All Museums",
            "data" : [599, 222, 597, 848]
            // "data" : [0.314,  0.116, 0.313, 0.444]
          },
          // {
            // "name" : "My Museum",
            // "data" : [1,34,12,4]
      ...
      },
      {
        "id": 19,
        "labels" : ["1", "2", "3","4", "5"],
        "_comment":"TODO: Combine Boxes One and Two. Divide by 1907",
        "dataSet": [
          {
            "name" : "All Museums",
            "data" : [347, 528, 473, 430, 129]
            // "data" : [43,25,1,]
            // "data" : [43,25,1,]
          },
          // {
      ...
      },
      {
        ...
        "dataSet": [
          {
            "name" : "All Museums",
            "data" : [652, 684, 551, 179, 794, 240, 292, 642, 717, 536, 38]
            // "data" : [0.341, 0.358, 0.288, 0.093, 0.416, 0.125, 0.153, 0.336, 0.375, 0.281, 0.019]
          },
          // {
            // "name" : "My Museum",
      ...
      },
      {
        ...
        "dataSet": [
          {
            "name" : "All Museums",
            "data" : [457, 1326,  124, 1,1.48,2.03,1.60, 1.48, 1.64, 1.49, 2.13, 1.18, 1.31, 1.83, 1.88, 1.99]
            // "data" : [0.239,  0.695, 0.065, 1,1.48,2.03,1.60, 1.48, 1.64, 1.49, 2.13, 1.18, 1.31, 1.83, 1.88, 1.99]
          },
          // {
            // "name" : "My Museum",
      ...
      },
      {
        ...
        "dataSet": [
          {
            "name" : "All Museums",
            "data" : [252, 52, 160, 138, 26, 92, 62, 101, 6]
            // "data" : [0.520,  0.107, 0.330, 0.285, 0.053, 0.396, 0.128, 0.208, 0.012]
          },
          // {
            // "name" : "My Museum",
      ...
      },
      {
        ...
        "dataSet": [
          {
            "name" : "All Museums",
            "data" : [54, 139, 22,  3, 123, 15,  24,  1, 101, 221]
            // "data" : [0.113,  0.292, 0.046, 0.006, 0.258, 0.031, 0.050, 0.002, 0.212, 0.465]
          },
          // {
            // "name" : "My Museum",
      ...
      },
      {
        ...
        "dataSet": [
          {
            "name" : "All Museums",
            "data" : [214,217,326,72,87,50,45,2]
            // "data" : [0.460,  0.466, 0.701, 0.154, 0.187, 0.107, 0.096, 0.004]
          },
          // {
            // "name" : "My Museum",
      ...
      },
      {
        ...
        "dataSet": [
          {
            "name" : "All Museums",
            "data" : [705, 107, 76,  617, 163, 587, 56,  258, 671, 326, 279, 524, 287, 221, 11]
            // "data" : [0.614,  0.093, 0.066, 0.537, 0.142, 0.511, 0.048, 0.224, 0.585, 0.284, 0.243, 0.456, 0.250, 0.192, 0.009]
          },
          // {
            // "name" : "My Museum",
      ...
      },
      {
        ...
        "dataSet": [
          {
            "name" : "All Museums",
            "data" : [881,284,252,130,144,614,53,707,462,205,531,197,382,22]
            // "data" : [0.676,  0.218, 0.193, 0.099, 0.110, 0.471, 0.040, 0.543, 0.354, 0.157, 0.407, 0.151, 0.293, 0.016]
          },
          // {
            // "name" : "My Museum",
      ...
      },
      {
        ...
        "dataSet": [
          {
            "name" : "All Museums",
            "data" : [1290,337,215,142,364,216,55]
            // "data" : [0.676,  0.176, 0.112, 0.074, 0.190, 0.113, 0.028]
          },
          // {
            // "name" : "My Museum",
      ...
      },
      {
        ...
        "dataSet": [
          {
            "name" : "All Museums",
            "data" : [935,854,987,279,49, 723]
            // "data" : [0.490 0.447 0.517 0.146 0.025 0.379]
          },
          // {
            // "name" : "My Museum",
            // "data" : [43,25,1,2,3,4]
      ...
      },
      {
        ...
        "dataSet": [
          {
            "name" : "All Museums",
            "data" : [714,328,414,621,28, 54]
            // "data" : [0.374, 0.171, 0.217, 0.325, 0.014, 0.028]
          },
          // {
            // "name" : "My Museum",
      ...
      },
      {
        ...
        "dataSet": [
          {
            "name" : "All Museums",
            "data" : [236, 115, 216, 725, 315, 310, 427]
            // "data" : [0.123,  0.060, 0.113, 0.380, 0.165, 0.162, 0.223]
          },
          // {
            // "name" : "My Museum",
      ...
      },
      {
        ...
        "dataSet": [
          {
            "name" : "All Museums",
            "data" : [1079,787,791,359,1591,497,348,458,61]
          },
          // {
            // "name" : "My Museum",
            // "data" : [1,1.2,1.6,.7,.9,.1,.5,1.3,2,.1,.5,.6,.3,1]
      ...
      },
      {
        ...
        "dataSet": [
          {
            "name" : "All Museums",
            "data" : [1107,1306,572,462,584,232]
            // "data" : [0.580,  0.684, 0.299, 0.242, 0.306, 0.121]
          },
          // {
            // "name" : "My Museum",
            // "data" : [1,34,12,43,25,1]
